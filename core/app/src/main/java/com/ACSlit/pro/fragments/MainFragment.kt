...
import com.ACSlit.pro.activities.PreferencesActivity
import com.ACSlit.pro.activities.TerminalActivity
import com.ACSlit.pro.adapters.MainActionsListAdapter
import com.ACSlit.pro.app.BaseApplication
import com.ACSlit.pro.app.BaseIDEActivity
import com.ACSlit.pro.common.databinding.LayoutDialogProgressBinding
import com.ACSlit.pro.databinding.BottomsheetGitCloneBinding
import com.ACSlit.pro.databinding.FragmentMainBinding
import com.ACSlit.pro.models.MainScreenAction
import com.ACSlit.pro.resources.R.string
import com.ACSlit.pro.tasks.runOnUiThread
import com.ACSlit.pro.templates.preferences.WizardPreferences
import com.ACSlit.pro.utils.DialogUtils
import com.ACSlit.pro.utils.Environment
import com.ACSlit.pro.utils.GeneralFileUtils
...
class MainFragment : BaseFragment() {
  ...
  private fun showCreateProject() {
    com.ACSlit.pro.templates
        .AtcInterface()
        .create(
            requireContext(),
            object : com.ACSlit.pro.templates.AtcInterface.TemplateCreationListener {
