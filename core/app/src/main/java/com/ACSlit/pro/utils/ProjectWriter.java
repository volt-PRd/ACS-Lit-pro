...
public class ProjectWriter {
  ...
  @NonNull
  public static String createKotlinInterface(String packageName, String interfaceName) {
    return "package " + packageName + "\n\n" +
  ...
  @NonNull
  public static String createKotlinEnum(String packageName, String enumName) {
    return "package " + packageName + "\n\n" +
           "enum class " + enumName + " {\n" +
           "    \n" +
           "}\n";
  ...
  @NonNull
  public static String createKotlinActivity(String packageName, String activityName) {
    String layoutName = createLayoutName(activityName + ".xml");
    // Remove the .xml extension from layout name for R.layout reference
