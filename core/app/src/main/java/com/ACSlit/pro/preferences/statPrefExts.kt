...
class StatsCollection(
    ...
    SwitchPreference(
        setValue = StatPreferences::statOptIn::set,
...
private abstract class StatDataPreference(private val getValue: () -> String) : SimplePreference() {

  override val summary: Int? = null
  override val icon: Int? = null

  override fun onCreatePreference(context: Context): Preference {
    return super.onCreatePreference(context).apply { summary = getValue() }
  }
}
