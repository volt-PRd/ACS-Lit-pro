...
import com.ACSlit.pro.preferences.databinding.LayoutDialogTextInputBinding
import com.ACSlit.pro.projects.FileManager
import com.ACSlit.pro.tasks.launchAsyncWithProgress
import com.ACSlit.pro.utils.DialogUtils
import com.ACSlit.pro.utils.FlashType
import com.ACSlit.pro.utils.flashMessage
...
class RenameAction(context: Context, override val order: Int) :
  ...
  override suspend fun execAction(data: ActionData) {
    ...
    binding.name.editText!!.hint = context.getString(com.ACSlit.pro.resources.R.string.new_name)
    binding.name.editText!!.setText(file.name)
    builder.setTitle(com.ACSlit.pro.resources.R.string.rename_file)
    builder.setMessage(com.ACSlit.pro.resources.R.string.msg_rename_file)
    builder.setView(binding.root)
    builder.setNegativeButton(android.R.string.cancel, null)
    builder.setPositiveButton(com.ACSlit.pro.resources.R.string.rename_file) { dialogInterface, _ ->
      dialogInterface.dismiss()
      actionScope.launchAsyncWithProgress(
          configureFlashbar = { builder, cancelChecker ->
            builder.message(com.ACSlit.pro.resources.R.string.please_wait)
          },
          action = { _, _ ->
            ...
            withContext(Dispatchers.Main) {
              flashMessage(
                  if (renamed) com.ACSlit.pro.resources.R.string.renamed
                  else com.ACSlit.pro.resources.R.string.rename_failed,
