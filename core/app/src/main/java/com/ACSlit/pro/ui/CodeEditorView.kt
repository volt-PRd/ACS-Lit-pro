...
import com.ACSlit.pro.activities.editor.BaseEditorActivity
import com.ACSlit.pro.app.BaseApplication
import com.ACSlit.pro.editor.api.IEditor
import com.ACSlit.pro.editor.databinding.LayoutCodeEditorBinding
import com.ACSlit.pro.editor.ui.EditorSearchLayout
import com.ACSlit.pro.editor.ui.IDEEditor
import com.ACSlit.pro.editor.ui.IDEEditor.Companion.createInputTypeFlags
import com.ACSlit.pro.editor.ui.cleanupCompletionTooltips
import com.ACSlit.pro.editor.ui.cleanupHoverTooltips
import com.ACSlit.pro.editor.ui.clearDiagnostics
import com.ACSlit.pro.editor.ui.initCompletionTooltips
import com.ACSlit.pro.editor.ui.initDiagnosticHandling
import com.ACSlit.pro.editor.ui.initHoverTooltips
import com.ACSlit.pro.editor.ui.updateEditorDiagnostics
import com.ACSlit.pro.editor.utils.ContentReadWrite.readContent
import com.ACSlit.pro.editor.utils.ContentReadWrite.writeTo
import com.ACSlit.pro.eventbus.events.preferences.PreferenceChangeEvent
...
import com.ACSlit.pro.artificial.completion.SuggestionView
...
class CodeEditorView(context: Context, file: File, selection: Range) :
  ...
  private fun onCustomFontPrefChanged() {
    ...
    var fontPath = "${com.ACSlit.pro.utils.Environment.HOME}/.androidide/ui/${EditorPreferences.selectedCustomFont}"
    if (fontPath == "${com.ACSlit.pro.utils.Environment.HOME}/.androidide/ui/null") {
      fontPath = "${com.ACSlit.pro.utils.Environment.HOME}/.androidide/ui/jetbrains-mono.ttf"
    }
