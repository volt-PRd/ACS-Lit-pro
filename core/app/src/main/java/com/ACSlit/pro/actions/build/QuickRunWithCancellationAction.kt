...
package com.ACSlit.pro.actions.build
...
import com.ACSlit.pro.actions.BaseBuildAction
import com.ACSlit.pro.actions.getContext
import com.ACSlit.pro.actions.markInvisible
import com.ACSlit.pro.actions.openApplicationModuleChooser
...
import com.ACSlit.pro.models.ApkMetadata
...
import com.ACSlit.pro.ui.InstallingDialog
import com.ACSlit.pro.utils.ApkInstaller
import com.ACSlit.pro.utils.InstallationResultHandler
...
class QuickRunWithCancellationAction(context: Context, override val order: Int) :
  ...
  private fun cancelBuild(): Boolean {
    ...
    if (builder?.isToolingServerStarted() != true) {
      flashError(com.ACSlit.pro.projects.R.string.msg_tooling_server_unavailable)
      return false
    }
  ...
  private fun install(data: ActionData, apk: File) {
    ...
    if (prefManager.getBoolean(INSTALL_VIA_SHIZUKU, false)) {
      ...
      SilentInstaller.install(
          apk,
          object : SilentInstaller.InstallCallback {
