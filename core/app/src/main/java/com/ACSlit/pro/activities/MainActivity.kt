...
import com.ACSlit.pro.activities.editor.EditorActivityKt
import com.ACSlit.pro.app.EdgeToEdgeIDEActivity
import com.ACSlit.pro.databinding.ActivityMainBinding
...
import com.ACSlit.pro.viewmodel.MainViewModel.Companion.SCREEN_MAIN
import com.ACSlit.pro.viewmodel.MainViewModel.Companion.SCREEN_TEMPLATE_DETAILS
import com.ACSlit.pro.viewmodel.MainViewModel.Companion.SCREEN_TEMPLATE_LIST
import com.ACSlit.pro.setup.updater.lsp.KotlinLspUpdater
import com.ACSlit.pro.setup.updater.lsp.data.LSPProperties
import java.io.File
    ...
    val currentFragment =
        when (screen) {
          ...
          SCREEN_TEMPLATE_LIST ->
              com.ACSlit.pro.templates.AtcInterface().create(this) // binding.templateList
