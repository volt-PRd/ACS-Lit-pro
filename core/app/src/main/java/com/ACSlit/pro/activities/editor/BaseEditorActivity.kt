...
package com.ACSlit.pro.activities.editor
...
import com.ACSlit.pro.adapters.DiagnosticsAdapter
import com.ACSlit.pro.adapters.SearchListAdapter
import com.ACSlit.pro.app.EdgeToEdgeIDEActivity
import com.ACSlit.pro.databinding.ActivityEditorBinding
import com.ACSlit.pro.databinding.ContentEditorBinding
import com.ACSlit.pro.databinding.LayoutDiagnosticInfoBinding
import com.ACSlit.pro.events.InstallationResultEvent
import com.ACSlit.pro.fragments.SearchResultFragment
import com.ACSlit.pro.fragments.sidebar.EditorSidebarFragment
import com.ACSlit.pro.fragments.sidebar.FileTreeFragment
import com.ACSlit.pro.handlers.EditorActivityLifecyclerObserver
import com.ACSlit.pro.handlers.LspHandler.registerLanguageServers
import com.ACSlit.pro.interfaces.DiagnosticClickListener
import com.ACSlit.pro.lookup.Lookup
import com.ACSlit.pro.lsp.models.DiagnosticItem
import com.ACSlit.pro.models.DiagnosticGroup
import com.ACSlit.pro.models.OpenedFile
import com.ACSlit.pro.models.Range
import com.ACSlit.pro.models.SearchResult
import com.ACSlit.pro.preferences.internal.BuildPreferences
import com.ACSlit.pro.projectdata.state.lsp.Index
import com.ACSlit.pro.indexing.views.IndexingBanner
import com.ACSlit.pro.projectdata.state.Initialization
import com.ACSlit.pro.projectdata.logs.LogStream
import com.ACSlit.pro.projects.IProjectManager
import com.ACSlit.pro.tasks.cancelIfActive
import com.ACSlit.pro.ui.CodeEditorView
import com.ACSlit.pro.ui.ContentTranslatingDrawerLayout
import com.ACSlit.pro.ui.SwipeRevealLayout
import com.ACSlit.pro.uidesigner.UIDesignerActivity
import com.ACSlit.pro.utils.ActionMenuUtils.createMenu
import com.ACSlit.pro.utils.ApkInstallationSessionCallback
import com.ACSlit.pro.utils.DialogUtils.newMaterialDialogBuilder
import com.ACSlit.pro.utils.Environment
import com.ACSlit.pro.utils.InstallationResultHandler.onResult
import com.ACSlit.pro.utils.IntentUtils
import com.ACSlit.pro.utils.MemoryUsageWatcher
import com.ACSlit.pro.utils.flashError
import com.ACSlit.pro.utils.flashInfo
import com.ACSlit.pro.utils.flashSuccess
import com.ACSlit.pro.utils.resolveAttr
import com.ACSlit.pro.viewmodel.EditorViewModel
import com.ACSlit.pro.xml.resources.ResourceTableRegistry
import com.ACSlit.pro.xml.versions.ApiVersionsRegistry
import com.ACSlit.pro.xml.widgets.WidgetTableRegistry
import com.ACSlit.pro.setup.Setup
import com.ACSlit.pro.experimental.depsupdater.DependencyUpdaterDialog
import com.ACSlit.pro.preferences.internal.BuildPreferences.isKtIndexingNotificationEnabled
import java.io.File
...
import com.ACSlit.pro.projects.internal.ProjectManagerImpl
...
override fun onApplySystemBarInsets(insets: Insets) {
  ...
  private fun setupMemUsageChart() {
    binding.memUsageView.chart.apply {
      ...
      (application as? com.ACSlit.pro.app.IDEApplication)
          ?.getChartCleanupTask()
          ?.registerChart(this)
    }
  }
