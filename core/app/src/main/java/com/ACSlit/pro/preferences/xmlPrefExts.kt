...
import com.ACSlit.pro.preferences.internal.XmlPreferences
...
private class TrimFinalNewLines(
    ...
    SwitchPreference(
        setValue = XmlPreferences::trimFinalNewLine::set,
...
private class InsertFinalNewLine(
    ...
    SwitchPreference(
        setValue = XmlPreferences::insertFinalNewLine::set,
...
private class SplitAttributes(
    ...
    SwitchPreference(
        setValue = XmlPreferences::splitAttributes::set,
...
private class JoinCDataLines(
    ...
    SwitchPreference(
        setValue = XmlPreferences::joinCDataLines::set,
...
private class JoinCommentLines(
    ...
    SwitchPreference(
        setValue = XmlPreferences::joinCommentLines::set,
...
private class JoinContentLines(
    ...
    SwitchPreference(
        setValue = XmlPreferences::joinContentLines::set,
...
private class PreserveEmptyContent(
    ...
    SwitchPreference(
        setValue = XmlPreferences::preserveEmptyContent::set,
...
private class EmptyElementsBehavior(
  ...
  override fun onChoiceConfirmed(
    ...
    XmlPreferences.emptyElementsBehavior =
        (entry?.data as? EmptyElements?)?.toString() ?: "Collapse"
  }
}
