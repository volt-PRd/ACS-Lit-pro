...
import com.ACSlit.pro.databinding.FragmentSubModuleBinding
import com.ACSlit.pro.projects.IProjectManager
import com.ACSlit.pro.utils.ModuleCreator
import java.io.File
...
class SubModuleFragment : Fragment() {
  ...
  override fun onDestroy() {
      super.onDestroy()
      com.ACSlit.pro.utils.EditorSidebarActions.removeFragmentFromCache("ide.editor.sidebar.subModule")
  }
}
