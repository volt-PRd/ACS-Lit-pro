package com.ACSlit.pro.templates
...
import com.ACSlit.pro.templates.android.etc.NativeCpp.Check
...
internal object SafResolver {
  ...
  private const val ANDROIDIDE_DOCS_AUTHORITY = "com.ACSlit.pro.documents"
