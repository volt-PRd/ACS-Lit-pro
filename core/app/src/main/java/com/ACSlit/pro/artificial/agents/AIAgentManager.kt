...
package com.ACSlit.pro.artificial.agents

import android.content.Context
import com.ACSlit.pro.artificial.agents.google.Gemini
import com.ACSlit.pro.artificial.agents.openai.OpenAI
import com.ACSlit.pro.artificial.agents.anthropic.Anthropic
import com.ACSlit.pro.artificial.agents.grok.Grok
import com.ACSlit.pro.artificial.agents.deepseek.DeepSeek
import com.ACSlit.pro.artificial.agents.local.LocalLLM
import com.ACSlit.pro.artificial.file.FileWriteResult
import com.ACSlit.pro.artificial.parser.SnippetParser
import com.ACSlit.pro.artificial.permissions.AIPermissionManager
import com.ACSlit.pro.artificial.project.awareness.ProjectData
import com.ACSlit.pro.artificial.secrets.ApiKey
import java.io.File
import kotlinx.coroutines.delay
import com.ACSlit.pro.artificial.dialogs.ProviderSwitchDialog
...
class AIAgentManager(private val context: Context) {
            ...
            try {
                ...
                result.fold(
                  ...
                  onFailure = { error ->
                      ...
                      val shouldSwitchProvider = error is com.ACSlit.pro.artificial.exceptions.RateLimitException ||
                                                error is com.ACSlit.pro.artificial.exceptions.QuotaExceededException ||
                                                error is com.ACSlit.pro.artificial.exceptions.InsufficientBalanceException ||
                                                error is com.ACSlit.pro.artificial.exceptions.InvalidApiKeyException
    ...
    private fun formatErrorMessage(error: Throwable): String {
        ...
        return when (error) {
            is com.ACSlit.pro.artificial.exceptions.RateLimitException -> 
                "⚠️ RATE LIMIT EXCEEDED\n\nThe API rate limit has been exceeded.\nPlease wait a few minutes before trying again.\n\nDetails: $errorMessage"
            is com.ACSlit.pro.artificial.exceptions.QuotaExceededException -> 
                "⚠️ QUOTA EXCEEDED\n\nYour API quota has been exhausted.\nPlease check your billing or upgrade your plan.\n\nDetails: $errorMessage"
            is com.ACSlit.pro.artificial.exceptions.InsufficientBalanceException -> 
                "💳 INSUFFICIENT BALANCE\n\nYour account balance is too low to process this request.\nPlease add credits or upgrade your plan.\n\nProvider: $providerName\n\nDetails: $errorMessage"
            is com.ACSlit.pro.artificial.exceptions.InvalidApiKeyException -> 
