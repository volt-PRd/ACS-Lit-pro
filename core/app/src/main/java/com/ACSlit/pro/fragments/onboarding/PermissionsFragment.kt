...
package com.ACSlit.pro.fragments.onboarding
...
import com.ACSlit.pro.adapters.onboarding.OnboardingPermissionsAdapter
import com.ACSlit.pro.buildinfo.BuildInfo
import com.ACSlit.pro.models.OnboardingPermissionItem
import com.ACSlit.pro.utils.flashError
import com.ACSlit.pro.utils.isAtLeastR
...
class PermissionsFragment : OnboardingMultiActionFragment(), SlidePolicy {
  ...
  companion object {
    ...
    fun areAllPermissionsGranted(context: Context): Boolean =
        getRequiredPermissions(context).all { it.isGranted }
  ...
  override fun createAdapter(): RecyclerView.Adapter<*> {
    return OnboardingPermissionsAdapter(permissions, this::requestPermission).also {
      this.adapter = it
    }
  }
