...
class ModuleCreator {
  ...
  fun createModule(
      moduleName: String,
      language: com.ACSlit.pro.fragments.sidebar.SubModuleFragment.ModuleLanguage,
      projectRoot: File,
  ): CreationResult {
    return try {
  ...
  private fun createModuleStructure(
    ...
    val javaDir =
        File(
            srcMainDir,
            if (
                language == com.ACSlit.pro.fragments.sidebar.SubModuleFragment.ModuleLanguage.KOTLIN
            )
                "kotlin"
            else "java",
        )
  ...
  private fun generateKotlinDslBuildScript(
    ...
    val kotlinPlugin =
        if (language == com.ACSlit.pro.fragments.sidebar.SubModuleFragment.ModuleLanguage.KOTLIN) {
          "id(\"kotlin-android\")"
        } else {
