...
import com.ACSlit.pro.shell.executeProcessAsync
...
import com.ACSlit.pro.tooling.api.util.ToolingApiLauncher
            ...
            try {
              ...
              val command =
                  listOf(
                      ...
                      "-D${CoreConstants.STATUS_LISTENER_CLASS_KEY}=com.ACSlit.pro.tooling.impl.util.LogbackStatusListener",
                      "-jar",
