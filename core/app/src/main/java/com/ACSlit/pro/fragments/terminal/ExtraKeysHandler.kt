package com.ACSlit.pro.fragments.terminal
...
class ExtraKeysHandler(
    ...
    fun setup() {
        extraKeysLayout = rootView.findViewById(com.ACSlit.pro.R.id.extra_keys_include)
        
        ctrlButton = extraKeysLayout?.findViewById(com.ACSlit.pro.R.id.key_ctrl)
        altButton = extraKeysLayout?.findViewById(com.ACSlit.pro.R.id.key_alt)
    ...
    private fun setupKeyCodeButtons() {
        mapOf(
            com.ACSlit.pro.R.id.key_esc to KeyEvent.KEYCODE_ESCAPE,
            com.ACSlit.pro.R.id.key_tab to KeyEvent.KEYCODE_TAB,
            com.ACSlit.pro.R.id.key_up to KeyEvent.KEYCODE_DPAD_UP,
            com.ACSlit.pro.R.id.key_down to KeyEvent.KEYCODE_DPAD_DOWN,
            com.ACSlit.pro.R.id.key_left to KeyEvent.KEYCODE_DPAD_LEFT,
            com.ACSlit.pro.R.id.key_right to KeyEvent.KEYCODE_DPAD_RIGHT,
            com.ACSlit.pro.R.id.key_home to KeyEvent.KEYCODE_MOVE_HOME,
            com.ACSlit.pro.R.id.key_end to KeyEvent.KEYCODE_MOVE_END,
            com.ACSlit.pro.R.id.key_pgup to KeyEvent.KEYCODE_PAGE_UP,
            com.ACSlit.pro.R.id.key_pgdn to KeyEvent.KEYCODE_PAGE_DOWN
        ).forEach { (id, keyCode) ->
    ...
    private fun setupTextButtons() {
        mapOf(
            com.ACSlit.pro.R.id.key_slash to "/",
            com.ACSlit.pro.R.id.key_minus to "-",
            com.ACSlit.pro.R.id.key_pipe to "|"
        ).forEach { (id, text) ->
            rootView.findViewById<MaterialButton>(id)?.setOnClickListener { 
                sendText(text)
                resetModifiers()
