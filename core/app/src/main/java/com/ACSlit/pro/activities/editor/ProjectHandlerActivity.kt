...
import com.ACSlit.pro.databinding.LayoutSearchProjectBinding
import com.ACSlit.pro.flashbar.Flashbar
import com.ACSlit.pro.fragments.sheets.ProgressSheet
import com.ACSlit.pro.handlers.EditorBuildEventListener
import com.ACSlit.pro.handlers.LspHandler.connectClient
import com.ACSlit.pro.handlers.LspHandler.destroyLanguageServers
import com.ACSlit.pro.lookup.Lookup
import com.ACSlit.pro.lsp.IDELanguageClientImpl
import com.ACSlit.pro.lsp.java.utils.CancelChecker
import com.ACSlit.pro.preferences.internal.GeneralPreferences
import com.ACSlit.pro.projects.GradleProject
import com.ACSlit.pro.projects.builder.BuildService
import com.ACSlit.pro.projects.internal.ProjectManagerImpl
import com.ACSlit.pro.services.builder.GradleBuildService
import com.ACSlit.pro.services.builder.GradleBuildServiceConnnection
import com.ACSlit.pro.services.builder.gradleDistributionParams
import com.ACSlit.pro.tasks.executeAsyncProvideError
import com.ACSlit.pro.tasks.executeWithProgress
import com.ACSlit.pro.tooling.api.messages.AndroidInitializationParams
...
import com.ACSlit.pro.tooling.api.models.BuildVariantInfo
import com.ACSlit.pro.tooling.api.models.mapToSelectedVariants
import com.ACSlit.pro.utils.DURATION_INDEFINITE
import com.ACSlit.pro.utils.DialogUtils.newMaterialDialogBuilder
import com.ACSlit.pro.utils.RecursiveFileSearcher
import com.ACSlit.pro.utils.flashError
import com.ACSlit.pro.utils.flashbarBuilder
import com.ACSlit.pro.utils.resolveAttr
import com.ACSlit.pro.utils.showOnUiThread
import com.ACSlit.pro.utils.withIcon
import com.ACSlit.pro.viewmodel.BuildVariantsViewModel
import java.io.File
  ...
  fun initializeProject(buildVariantsProvider: () -> Map<String, String>) {
    executeWithProgress { progress ->
      executeAsyncProvideError(buildVariantsProvider::invoke) { result, error ->
        com.ACSlit.pro.tasks.runOnUiThread { progress.dismiss() }
        ...
        com.ACSlit.pro.tasks.runOnUiThread { initializeProject(result) }
      }
    }
  }
  ...
  protected open fun onProjectInitialized(result: InitializeResult) {
    ...
    editorActivityScope.launch(Dispatchers.IO) {
      try {
        ...
        if (workspace == null) {
          com.ACSlit.pro.tasks.runOnUiThread {
        ...
        com.ACSlit.pro.tasks.runOnUiThread { postProjectInit(true, null) }
      } catch (e: Exception) {
