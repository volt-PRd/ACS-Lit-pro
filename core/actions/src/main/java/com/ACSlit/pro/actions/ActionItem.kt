 ...
 * [com.ACSlit.pro.actions.ActionsRegistry]
 *
 * @author Akash Yadav
 */
interface ActionItem {
  ...
  /**
   * The subtitle for this action. This provides additional context or summary information. This is
   * optional and can be null or empty.
   */
  var subtitle: String?
    get() = null
    set(value) {}
