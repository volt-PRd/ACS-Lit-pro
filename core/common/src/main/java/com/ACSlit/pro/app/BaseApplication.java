...
import com.ACSlit.pro.common.R;
...
import com.ACSlit.pro.utils.FileUtil;
import com.ACSlit.pro.utils.FlashbarUtilsKt;
import com.ACSlit.pro.utils.JavaCharacter;
  ...
  private void initKotlinServer() {
    new Thread(() -> {
      try {
        ...
        Class<?> managerClass = Class.forName("com.ACSlit.pro.lsp.kotlin.KotlinServerProcessManager");
        Class<?> providerClass = Class.forName("com.ACSlit.pro.lsp.kotlin.KotlinClasspathProvider");
