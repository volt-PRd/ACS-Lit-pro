 ...
 *
 * @property isConnected Indicates whether the device is able to reach the internet. See
 *   [NetworkCapabilities.NET_CAPABILITY_INTERNET].
 * @property isCellularTransport Indicates whether the device is using a cellular transport. See
 *   [NetworkCapabilities.TRANSPORT_CELLULAR].
 * @property isMeteredConnection Indicates whether the device is using a cellular transport. See
 *   [NetworkCapabilities.NET_CAPABILITY_NOT_METERED] and
 *   [NetworkCapabilities.NET_CAPABILITY_TEMPORARILY_NOT_METERED].
 * @property isBackgroundDataRestricted Indicates whether the background data is restricted. If the
 *   application is whitelisted from background data restriction, this will be `false`. See
 *   [NetworkCapabilities.TRANSPORT_CELLULAR].
 * @author Akash Yadav
 */
...
fun getConnectionInfo(
  ...
  val connectivityManager =
      context.getSystemService<ConnectivityManager>() ?: return ConnectionInfo.UNKNOWN
  val activeNetCapabilities =
      networkCapabilities
          ?: connectivityManager.activeNetwork?.let(connectivityManager::getNetworkCapabilities)
          ?: return ConnectionInfo.UNKNOWN

  val isConnected =
      activeNetCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_VALIDATED)
  val isCellularTransport =
      activeNetCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR)
  ...
  // RESTRICT_BACKGROUND_STATUS_WHITELISTED -> background data usage might be restricted, but the
  // application is whitelisted
  val isBackgroundDataRestricted =
      !connectivityManager.restrictBackgroundStatus.let {
