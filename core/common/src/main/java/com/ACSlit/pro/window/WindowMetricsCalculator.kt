...
internal interface WindowMetricsCalculator {
   ...
   *
   * The value returned from this method may be different from platform API(s) used to determine the
   * size and position of the visible area a given context occupies. For example:
   ...
   *   displayed behind a display cutout will have the size of the decor view offset to exclude this
   *   region unless this region overlaps with the status bar, while the value returned from this
   *   method will include this region.
   *
