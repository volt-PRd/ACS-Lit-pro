...
import com.ACSlit.pro.window.ActivityCompatHelperApi24.isInMultiWindowMode
import com.ACSlit.pro.window.ActivityCompatHelperApi30.currentWindowBounds
import com.ACSlit.pro.window.ActivityCompatHelperApi30.maximumWindowBounds
import com.ACSlit.pro.window.DisplayCompatHelperApi17.getRealSize
import com.ACSlit.pro.window.DisplayCompatHelperApi28.safeInsetBottom
import com.ACSlit.pro.window.DisplayCompatHelperApi28.safeInsetLeft
import com.ACSlit.pro.window.DisplayCompatHelperApi28.safeInsetRight
import com.ACSlit.pro.window.DisplayCompatHelperApi28.safeInsetTop
...
internal object WindowMetricsCalculatorCompat : WindowMetricsCalculator {
  ...
  override fun computeCurrentWindowMetrics(activity: Activity): WindowMetrics {
    val bounds =
        ...
        } else computeWindowBoundsN(activity)
   ...
   *   anchored at (0, 0).
   * * If the [android.content.res.Resources] value stored at 'navigation_bar_height' does not match
   *   the true navigation bar size the returned bounds will not take into account the navigation
   *   bar.
   */
  ...
  /**
   * Returns the full (real) size of the display, in pixels, without subtracting any window decor or
