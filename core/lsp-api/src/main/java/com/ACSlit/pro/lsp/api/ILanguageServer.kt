...
interface ILanguageServer {
   ...
   * [getRootWorkspace()][com.ACSlit.pro.projects.IProjectManager.workspace] to obtain the workspace
   * instance.
   *
  ...
  suspend fun hover(params: DefinitionParams): com.ACSlit.pro.lsp.models.MarkupContent {
