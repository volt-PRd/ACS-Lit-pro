...
package com.ACSlit.pro.lsp.internal.model
...
private constructor(
    ...
    val result: com.ACSlit.pro.lsp.models.CompletionResult,
) {
  ...
  companion object {
    ...
    val EMPTY =
        cache(
            CompletionParams(
                com.ACSlit.pro.models.Position.NONE,
                Paths.get(""),
                ICancelChecker.CANCELLED,
            ),
            com.ACSlit.pro.lsp.models.CompletionResult.EMPTY,
        )
    ...
    fun cache(
        ...
        result: com.ACSlit.pro.lsp.models.CompletionResult,
    ): CachedCompletion {
      val params =
