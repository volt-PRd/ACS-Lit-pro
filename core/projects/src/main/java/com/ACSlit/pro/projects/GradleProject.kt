 ...
 * [IGradleProject][com.ACSlit.pro.tooling.api.IGradleProject]. This project module caches all the
 * data from an [IGradleProject][com.ACSlit.pro.tooling.api.IGradleProject] eliminating the use of
 * [CompletableFuture] s.
 *
