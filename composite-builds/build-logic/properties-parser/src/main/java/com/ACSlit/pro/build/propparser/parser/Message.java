...
package com.ACSlit.pro.build.propparser.parser;

import java.util.ArrayList;
import java.util.List;

/**
 * A message within the message file. A message is a series of lines containing a "name=value"
 * property, optionally preceded by a comment describing the use of placeholders such as {0}, {1},
 * etc within the property value.
 */
public final class Message {
  ...
  /**
   * Get the Info object for this message. It may be empty if there if no comment preceding the
