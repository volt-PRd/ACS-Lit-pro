...
package com.ACSlit.pro.plugins.tasks

import com.ACSlit.pro.plugins.util.DownloadUtils
import com.ACSlit.pro.plugins.util.ELFUtils
import java.io.File
...
abstract class SetupAapt2Task : DefaultTask() {
  ...
  companion object {
    ...
    private const val AAPT2_DOWNLOAD_URL =
        "https://github.com/AndroidIDEOfficial/platform-tools/releases/download/v%1\$s/aapt2-%2\$s"
  }
