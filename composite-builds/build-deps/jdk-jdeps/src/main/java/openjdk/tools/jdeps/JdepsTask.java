...
package openjdk.tools.jdeps;

import openjdk.tools.jdeps.Analyzer.Type;
...
class JdepsTask {
    ...
    private static class ResourceBundleHelper {
        ...
        static {
            ...
            try {
                bundle = ResourceBundle.getBundle("openjdk.tools.jdeps.resources.jdeps", locale);
            } catch (MissingResourceException e) {
                throw new InternalError("Cannot find jdeps resource bundle for locale " + locale);
            }
            try {
                versionRB = ResourceBundle.getBundle("openjdk.tools.jdeps.resources.version");
            } catch (MissingResourceException e) {
                throw new InternalError("version.resource.missing");
            }
            try {
                jdkinternals = ResourceBundle.getBundle("openjdk.tools.jdeps.resources.jdkinternals");
            } catch (MissingResourceException e) {
