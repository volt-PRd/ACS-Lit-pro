...
package com.ACSlit.pro.tooling.impl

import com.ACSlit.pro.tooling.api.IProject
import com.ACSlit.pro.tooling.api.IToolingApiClient
import com.ACSlit.pro.tooling.api.IToolingApiServer
import com.ACSlit.pro.tooling.api.messages.GradleDistributionParams
import com.ACSlit.pro.tooling.api.messages.GradleDistributionType
import com.ACSlit.pro.tooling.api.messages.InitializeProjectParams
import com.ACSlit.pro.tooling.api.messages.TaskExecutionMessage
import com.ACSlit.pro.tooling.api.messages.result.BuildCancellationRequestResult
import com.ACSlit.pro.tooling.api.messages.result.BuildCancellationRequestResult.Reason.CANCELLATION_ERROR
import com.ACSlit.pro.tooling.api.messages.result.BuildInfo
import com.ACSlit.pro.tooling.api.messages.result.BuildResult
import com.ACSlit.pro.tooling.api.messages.result.InitializeResult
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_CANCELLED
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_FAILED
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_CLOSED
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_ERROR
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_DIRECTORY_INACCESSIBLE
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_DIRECTORY
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_FOUND
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_INITIALIZED
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.UNKNOWN
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_BUILD_ARGUMENT
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_CONFIGURATION
import com.ACSlit.pro.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_GRADLE_VERSION
import com.ACSlit.pro.tooling.api.models.ToolingServerMetadata
import com.ACSlit.pro.tooling.impl.internal.ProjectImpl
import com.ACSlit.pro.tooling.impl.net.SimpleHttpProxy
import com.ACSlit.pro.tooling.impl.sync.ModelBuilderException
import com.ACSlit.pro.tooling.impl.sync.RootModelBuilder
import com.ACSlit.pro.tooling.impl.sync.RootProjectModelBuilderParams
...
internal class ToolingApiServerImpl(private val project: ProjectImpl) : IToolingApiServer {
  ...
  override fun shutdown(): CompletableFuture<Void> {
    return CompletableFuture.supplyAsync {
      ...
      // see com.ACSlit.pro.tooling.impl.Main.main(String[])
