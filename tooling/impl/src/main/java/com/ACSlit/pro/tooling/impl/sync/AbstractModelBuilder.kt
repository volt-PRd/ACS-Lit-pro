...
import com.ACSlit.pro.builder.model.IDESyncIssue
import com.ACSlit.pro.tooling.api.messages.InitializeProjectParams
import com.ACSlit.pro.tooling.api.util.ToolingProps
import com.ACSlit.pro.utils.AndroidPluginVersion
import com.ACSlit.pro.utils.AndroidPluginVersion.Companion.MINIMUM_SUPPORTED
import com.ACSlit.pro.utils.ILogger
import com.ACSlit.pro.utils.LogUtils
...
abstract class AbstractModelBuilder<P, R>(
  ...
  companion object {
     ...
     * [ generateMessage(Object...)][com.ACSlit.pro.utils.ILogger.generateMessage] in
     * [ILogger][com.ACSlit.pro.utils.ILogger].
     *
