...
import com.ACSlit.pro.setup.R
import com.ACSlit.pro.resources.R.string
import com.ACSlit.pro.setup.servers.ILanguageServerInstaller
...
class Setup(private val context: Context) {
  ...
  private fun installLanguageServer(serverId: String, onComplete: ((Boolean) -> Unit)?) {
    ...
    val outputText = progressView.findViewById<com.ACSlit.pro.editor.ui.IDEEditor>(R.id.tv_output)
  ...
  private fun getLanguageServerInstaller(serverId: String): ILanguageServerInstaller {
    val className = "com.ACSlit.pro.setup.servers.${serverId}.${serverId.capitalize()}"
