...
package com.ACSlit.pro.lsp.java.edits
...
class MultipleClassImportEditHandler(
  ...
  override fun performEdits(
      ...
      editor: CodeEditor,
      completionItem: com.ACSlit.pro.lsp.models.CompletionItem,
  ) {
    val edits = mutableListOf<com.ACSlit.pro.lsp.models.TextEdit>()
    ...
    com.ACSlit.pro.lsp.util.RewriteHelper.performEdits(edits, editor)
  }
}
