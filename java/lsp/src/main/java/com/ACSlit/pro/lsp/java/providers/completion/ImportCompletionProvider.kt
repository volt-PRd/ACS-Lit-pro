...
import com.ACSlit.pro.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
...
import com.ACSlit.pro.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: com.ACSlit.pro.utils.ClassTrie, pkgName: String): Node? {
