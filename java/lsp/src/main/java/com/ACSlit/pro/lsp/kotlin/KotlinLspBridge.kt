    ...
    p0?.let { params ->
      val diagnostics =
          params.diagnostics.map { diagnostic ->
            com.ACSlit.pro.lsp.models.DiagnosticItem(
                message = diagnostic.message,
                code = diagnostic.code?.toString() ?: "",
                range =
                    com.ACSlit.pro.models.Range(
                        start =
                            com.ACSlit.pro.models.Position(
                ...
                severity =
                    when (diagnostic.severity) {
                      org.eclipse.lsp4j.DiagnosticSeverity.Error ->
                          com.ACSlit.pro.lsp.models.DiagnosticSeverity.ERROR
                      org.eclipse.lsp4j.DiagnosticSeverity.Warning ->
                          com.ACSlit.pro.lsp.models.DiagnosticSeverity.WARNING
                      org.eclipse.lsp4j.DiagnosticSeverity.Information ->
                          com.ACSlit.pro.lsp.models.DiagnosticSeverity.INFO
                      org.eclipse.lsp4j.DiagnosticSeverity.Hint ->
                          com.ACSlit.pro.lsp.models.DiagnosticSeverity.HINT
                      else -> com.ACSlit.pro.lsp.models.DiagnosticSeverity.ERROR
                    },
            )
          }
      ideClient.publishDiagnostics(
          com.ACSlit.pro.lsp.models.DiagnosticResult(
