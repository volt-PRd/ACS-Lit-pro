...
import com.ACSlit.pro.actions.newDialogBuilder
...
import com.ACSlit.pro.lsp.java.compiler.CompilerProvider
import com.ACSlit.pro.lsp.java.parser.ParseTask
import com.ACSlit.pro.lsp.java.rewrite.AddImport
import com.ACSlit.pro.lsp.java.utils.EditHelper
import com.ACSlit.pro.lsp.java.utils.FindHelper
import com.ACSlit.pro.lsp.java.utils.JavaParserUtils
import com.ACSlit.pro.lsp.java.utils.MethodPtr
import com.ACSlit.pro.lsp.java.visitors.FindTypeDeclarationAt
...
class OverrideSuperclassMethodsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (
        !visible ||
            !data.hasRequiredData(com.ACSlit.pro.models.Range::class.java, CodeEditor::class.java)
    ) {
      markInvisible()
      return
    }
  ...
  override suspend fun execAction(data: ActionData): Any {
    val range = data[com.ACSlit.pro.models.Range::class.java]!!
    val compiler =
