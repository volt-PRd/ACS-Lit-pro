...
import com.ACSlit.pro.lsp.models.InsertTextFormat
      ...
      classes.map { classInfo ->
        ...
        val additionalEdits =
            if (needsImport) {
              ...
              listOf(
                  com.ACSlit.pro.lsp.models.TextEdit(
                      range =
                          com.ACSlit.pro.models.Range(
                              start = com.ACSlit.pro.models.Position(line, 0),
                              end = com.ACSlit.pro.models.Position(line, 0),
                          ),
                      newText = importText,
                  )
              )
        ...
        CompletionItem(
            ...
            command = null,
            completionKind = com.ACSlit.pro.lsp.models.CompletionItemKind.CLASS,
            matchLevel = com.ACSlit.pro.lsp.models.MatchLevel.CASE_SENSITIVE_PREFIX,
