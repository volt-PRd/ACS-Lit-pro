...
import com.ACSlit.pro.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import com.ACSlit.pro.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import com.ACSlit.pro.lsp.java.visitors.DiagnosticVisitor
import com.ACSlit.pro.lsp.models.DiagnosticItem
import com.ACSlit.pro.lsp.models.DiagnosticSeverity
import com.ACSlit.pro.lsp.models.DiagnosticSeverity.WARNING
...
import com.ACSlit.pro.utils.DocumentUtils.isSameFile
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): com.ACSlit.pro.models.Position {
    abortIfCancelled()
    ...
    return com.ACSlit.pro.models.Position(line, column)
  }
