...
import com.ACSlit.pro.lsp.kotlin.providers.KotlinCodeFormatProvider
...
class KotlinLanguageServer(private val context: Context) : ILanguageServer {
  ...
  private val analyzeTimer = com.ACSlit.pro.lsp.java.utils.AnalyzeTimer { analyzeSelected() }
  ...
  private fun findCompilerService(workspace: IWorkspace): KotlinCompilerService? {
    val mainModule =
        workspace
            .getSubProjects()
            .filterIsInstance<com.ACSlit.pro.projects.android.AndroidModule>()
