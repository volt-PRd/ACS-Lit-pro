...
class KotlinEventHandler(private val documentManager: KotlinDocumentManager) {
  ...
  fun onContentChange(event: com.ACSlit.pro.eventbus.events.editor.DocumentChangeEvent) {
  ...
  @org.greenrobot.eventbus.Subscribe(threadMode = org.greenrobot.eventbus.ThreadMode.ASYNC)
  fun onFileOpened(event: com.ACSlit.pro.eventbus.events.editor.DocumentOpenEvent) {
  ...
  @org.greenrobot.eventbus.Subscribe(threadMode = org.greenrobot.eventbus.ThreadMode.ASYNC)
  fun onFileSelected(event: com.ACSlit.pro.eventbus.events.editor.DocumentSelectedEvent) {
  ...
  @org.greenrobot.eventbus.Subscribe(threadMode = org.greenrobot.eventbus.ThreadMode.ASYNC)
  fun onFileClosed(event: com.ACSlit.pro.eventbus.events.editor.DocumentCloseEvent) {
