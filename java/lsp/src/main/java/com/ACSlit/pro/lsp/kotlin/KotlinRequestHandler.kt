...
import com.ACSlit.pro.lsp.models.*
...
class KotlinRequestHandler(
  ...
  private fun extractPrefix(content: String, position: com.ACSlit.pro.models.Position): String {
  ...
  private fun convertToLocations(result: JsonObject?): List<com.ACSlit.pro.models.Location> {
    return result?.asJsonArray?.map { element ->
      ...
      com.ACSlit.pro.models.Location(
