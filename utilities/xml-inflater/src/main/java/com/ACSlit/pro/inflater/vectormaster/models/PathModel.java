...
package com.ACSlit.pro.inflater.vectormaster.models;
...
import com.ACSlit.pro.inflater.vectormaster.DefaultValues;
import com.ACSlit.pro.inflater.vectormaster.utilities.Utils;
import com.ACSlit.pro.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          com.ACSlit.pro.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
