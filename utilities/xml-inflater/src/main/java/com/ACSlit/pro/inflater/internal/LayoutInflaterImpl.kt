...
package com.ACSlit.pro.inflater.internal
...
import com.ACSlit.pro.inflater.DefaultComponentFactory
import com.ACSlit.pro.inflater.IAttribute
import com.ACSlit.pro.inflater.IComponentFactory
import com.ACSlit.pro.inflater.IComponentFactory.Companion.LAYOUT_INFLATER_COMPONENT_FACTORY_KEY
import com.ACSlit.pro.inflater.ILayoutInflater
import com.ACSlit.pro.inflater.INamespace
import com.ACSlit.pro.inflater.IView
import com.ACSlit.pro.inflater.IViewGroup
import com.ACSlit.pro.inflater.InflateException
import com.ACSlit.pro.inflater.events.IInflateEventsListener
import com.ACSlit.pro.inflater.events.InflationFinishEvent
import com.ACSlit.pro.inflater.events.InflationStartEvent
import com.ACSlit.pro.inflater.events.OnApplyAttributeEvent
import com.ACSlit.pro.inflater.events.OnInflateViewEvent
import com.ACSlit.pro.inflater.internal.utils.IDTable
import com.ACSlit.pro.inflater.internal.utils.ViewFactory.createViewInstance
import com.ACSlit.pro.inflater.internal.utils.ViewFactory.generateLayoutParams
import com.ACSlit.pro.inflater.internal.utils.parseLayoutReference
import com.ACSlit.pro.inflater.utils.endParse
import com.ACSlit.pro.inflater.utils.isParsing
import com.ACSlit.pro.inflater.utils.startParse
import com.ACSlit.pro.inflater.viewAdapter
import com.ACSlit.pro.lookup.Lookup
import com.ACSlit.pro.projects.android.AndroidModule
import com.ACSlit.pro.xml.widgets.Widget
import com.ACSlit.pro.xml.widgets.WidgetTable
import com.ACSlit.pro.xml.widgets.WidgetType
import java.io.File
...
open class LayoutInflaterImpl : ILayoutInflater {
  ...
  protected open fun processXmlFile(file: File): Pair<XmlProcessor, AndroidModule> {
    return com.ACSlit.pro.inflater.utils.processXmlFile(file, LAYOUT)
  }
  ...
  private fun startInflation(file: File) {
    ...
    if (!isParsing) {
      if (this.module == null) {
        startParse(file)
        this.module = com.ACSlit.pro.inflater.utils.module
      } else {
