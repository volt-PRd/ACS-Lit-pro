...
import com.ACSlit.pro.inflater.internal.LayoutInflaterImpl
...
interface ILayoutInflater : Closeable {
   ...
   *
   * **NOTE** : The [startParse][com.ACSlit.pro.inflater.utils.startParse] method is called if it
   * hasn't been called yet. However, the [endParse] [com.ACSlit.pro.inflater.utils.endParse] method
   ...
   * [com.ACSlit.pro.inflater.utils.endParse].
   *
