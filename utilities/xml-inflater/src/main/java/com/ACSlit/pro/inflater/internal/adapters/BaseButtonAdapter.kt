...
abstract class BaseButtonAdapter<T : Button> : IViewAdapter<T>() {
  ...
  override fun isRequiredAttribute(attribute: com.ACSlit.pro.inflater.IAttribute): Boolean {
    if (attribute.namespace?.uri != com.ACSlit.pro.inflater.INamespace.ANDROID.uri) {
      return false
    }
