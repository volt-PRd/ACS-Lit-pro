...
import com.ACSlit.pro.annotations.inflater.ViewAdapter
...
import com.ACSlit.pro.inflater.IViewAdapter
import com.ACSlit.pro.inflater.internal.IncludeView
import com.ACSlit.pro.inflater.models.UiWidget
import com.ACSlit.pro.inflater.utils.newAttribute
...
open class ViewAdapter<T : View> : IViewAdapter<T>() {
  ...
  protected open fun parseDrawingCacheQuality(value: String): Int {
    return com.ACSlit.pro.inflater.internal.utils.parseDrawingCacheQuality(value)
  }

  protected open fun parseVisibility(value: String): Int {
    return com.ACSlit.pro.inflater.internal.utils.parseVisibility(value)
  }

  protected open fun parseTextAlignment(value: String): Int {
    return com.ACSlit.pro.inflater.internal.utils.parseTextAlignment(value)
  }

  protected open fun parseTextDirection(value: String): Int {
    return com.ACSlit.pro.inflater.internal.utils.parseTextDirection(value)
  }

  protected open fun parsePorterDuffMode(mode: String): PorterDuff.Mode {
    return com.ACSlit.pro.inflater.internal.utils.parsePorterDuffMode(mode)
  }
