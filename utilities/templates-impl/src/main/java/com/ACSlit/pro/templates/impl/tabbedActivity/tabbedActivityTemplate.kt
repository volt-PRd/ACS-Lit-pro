...
package com.ACSlit.pro.templates.impl.tabbedActivity
...
fun tabbedActivityProject() = baseProjectImpl {
  ...
  thumb = R.drawable.blank_activity_tabs
  defaultAppModule {
    recipe = createRecipe {
      sources {
        writeMainActivity(this, ktSrc = ::tabbedActivitySrcKt, javaSrc = ::tabbedActivitySrcJava)
      }
