...
package com.ACSlit.pro.templates.impl.navDrawerActivity

import com.ACSlit.pro.templates.Language.Kotlin
import com.ACSlit.pro.templates.base.AndroidModuleTemplateBuilder
import com.ACSlit.pro.templates.base.models.Dependency
import com.ACSlit.pro.templates.base.modules.android.defaultAppModule
import com.ACSlit.pro.templates.base.util.AndroidModuleResManager.ResourceType.NAVIGATION
  ...
  defaultAppModule {
    recipe = createRecipe {
      ...
      res {
        ...
        writeXmlResource("mobile_navigation", NAVIGATION, source = ::navDrawerNavigationXmlSrc)
...
private fun AndroidModuleTemplateBuilder.navDrawerActivityProjectJava() {
  executor.apply {
    ...
    sources {
      ...
      writeJavaSrc("${data.packageName}.ui.home", "HomeFragment", source = ::homeFragmentSrcJava)
      writeJavaSrc("${data.packageName}.ui.home", "HomeViewModel", source = ::homeModelSrcJava)
...
private fun AndroidModuleTemplateBuilder.navDrawerActivityProjectKt() {
  executor.apply {
    ...
    sources {
      ...
      writeKtSrc("${data.packageName}.ui.gallery", "GalleryViewModel", source = ::galleryModelSrcKt)

      writeKtSrc("${data.packageName}.ui.home", "HomeFragment", source = ::homeFragmentSrcKt)
      writeKtSrc("${data.packageName}.ui.home", "HomeViewModel", source = ::homeModelSrcKt)
