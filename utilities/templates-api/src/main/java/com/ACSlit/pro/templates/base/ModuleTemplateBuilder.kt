...
import com.ACSlit.pro.templates.SrcSet
import com.ACSlit.pro.templates.TemplateBuilder
import com.ACSlit.pro.templates.TemplateRecipeConfigurator
import com.ACSlit.pro.templates.TemplateRecipeFinalizer
import com.ACSlit.pro.templates.base.models.Dependency
import com.ACSlit.pro.templates.base.models.defaultDependency
...
abstract class ModuleTemplateBuilder :
   ...
   * @see com.ACSlit.pro.templates.base.baseAsset
   */
  open fun baseAsset(path: String) = com.ACSlit.pro.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][com.ACSlit.pro.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
