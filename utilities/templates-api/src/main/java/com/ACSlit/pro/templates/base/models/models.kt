...
import com.ACSlit.pro.templates.base.models.DependencyConfiguration.Implementation
...
fun parseDependency(
  ...
  if (isPlatform) {
    require(split.size == 3) { "Maven coordinates must be in the form 'group:artifact:version'" }
  } else {
