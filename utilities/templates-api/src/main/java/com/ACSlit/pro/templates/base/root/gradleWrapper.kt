...
package com.ACSlit.pro.templates.base.root
...
internal fun ProjectTemplateBuilder.gradleWrapperPropsSrc(): String {
  return """
    ...
    distributionUrl=https\://services.gradle.org/distributions/gradle-${com.ACSlit.pro.templates.GRADLE_WRAPPER_DISTRIBUTION_VERSION}-bin.zip
