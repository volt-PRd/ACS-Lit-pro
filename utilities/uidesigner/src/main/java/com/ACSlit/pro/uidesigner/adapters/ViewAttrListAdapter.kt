...
package com.ACSlit.pro.uidesigner.adapters
...
import com.ACSlit.pro.inflater.IView.SingleAttributeChangeListener
import com.ACSlit.pro.uidesigner.R
import com.ACSlit.pro.uidesigner.adapters.ViewAttrListAdapter.VH
import com.ACSlit.pro.uidesigner.databinding.LayoutViewattrItemBinding
...
internal class ViewAttrListAdapter(
    attributes: List<com.ACSlit.pro.inflater.IAttribute>,
    private val viewModel: WorkspaceViewModel?,
    private val onDeleteAttr: (com.ACSlit.pro.inflater.IAttribute) -> Boolean,
    private val onClick: (com.ACSlit.pro.inflater.IAttribute) -> Unit,
