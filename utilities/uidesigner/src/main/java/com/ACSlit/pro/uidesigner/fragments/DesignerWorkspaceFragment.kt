...
import com.ACSlit.pro.fragments.BaseFragment
import com.ACSlit.pro.inflater.IView
import com.ACSlit.pro.inflater.internal.AttributeImpl
import com.ACSlit.pro.inflater.internal.LayoutFile
import com.ACSlit.pro.inflater.internal.ViewGroupImpl
import com.ACSlit.pro.inflater.internal.ViewImpl
import com.ACSlit.pro.inflater.utils.endParse
import com.ACSlit.pro.inflater.utils.startParse
import com.ACSlit.pro.uidesigner.R
import com.ACSlit.pro.uidesigner.UIDesignerActivity
import com.ACSlit.pro.uidesigner.databinding.FragmentDesignerWorkspaceBinding
import com.ACSlit.pro.uidesigner.drag.WidgetDragListener
import com.ACSlit.pro.uidesigner.drag.WidgetTouchListener
import com.ACSlit.pro.uidesigner.drawable.UiViewLayeredForeground
import com.ACSlit.pro.uidesigner.models.CommonUiView
import com.ACSlit.pro.uidesigner.models.PlaceholderView
import com.ACSlit.pro.uidesigner.models.RootWorkspaceView
import com.ACSlit.pro.uidesigner.models.UiViewGroup
import com.ACSlit.pro.uidesigner.undo.UndoManager
import com.ACSlit.pro.uidesigner.utils.UiLayoutInflater
import com.ACSlit.pro.uidesigner.utils.applyPreview
import com.ACSlit.pro.uidesigner.utils.bgDesignerView
import com.ACSlit.pro.uidesigner.utils.layeredForeground
import com.ACSlit.pro.uidesigner.viewmodel.M3ComponentState
import com.ACSlit.pro.uidesigner.viewmodel.WorkspaceViewModel
import java.io.File
...
class DesignerWorkspaceFragment : BaseFragment() {
  ...
  private fun createM3ComponentFromState(m3Component: M3ComponentState): IView? {
    return try {
      ...
      val layoutFile = com.ACSlit.pro.inflater.internal.LayoutFile(File(""), "")
      val iView =
          when (view) {
            is MaterialButton -> {
              // Use ViewImpl instead of checking the actual view type
              com.ACSlit.pro.inflater.internal.ViewImpl(layoutFile, m3Component.type, view)
            }
            is MaterialCardView -> {
              com.ACSlit.pro.inflater.internal.ViewGroupImpl(layoutFile, m3Component.type, view)
            }
            is MaterialTextView -> {
              com.ACSlit.pro.inflater.internal.ViewImpl(layoutFile, m3Component.type, view)
            }
        ...
        try {
          val namespace =
              if (attrName.startsWith("app:")) {
                com.ACSlit.pro.inflater.INamespace.APP
              } else {
                com.ACSlit.pro.inflater.INamespace.ANDROID
              }
          val attr =
              com.ACSlit.pro.inflater.internal.AttributeImpl(
                  namespace = namespace,
