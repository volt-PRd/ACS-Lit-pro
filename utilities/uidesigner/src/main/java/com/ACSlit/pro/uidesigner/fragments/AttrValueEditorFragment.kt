...
import com.ACSlit.pro.uidesigner.databinding.LayoutAttrValueEditorBinding
import com.ACSlit.pro.uidesigner.databinding.LayoutViewInfoHeaderBinding
import com.ACSlit.pro.uidesigner.utils.ValueCompletionProvider
      ...
      this.textWatcher =
          ValueCompletionProvider(viewModel.file, viewModel.view!! as ViewImpl, attr) { result ->
            ...
            try {
              ...
              // if (attr.name.equals("background", ignoreCase = true) && view is ViewImpl) {
              // // Pass the viewModel.file to the extension function
              // view.applyBackgroundPreview(requireContext(), viewModel.file)
              // }
              if (view is ViewImpl) {
