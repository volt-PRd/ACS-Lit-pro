...
package com.ACSlit.pro.uidesigner.views
...
constructor(
  ...
  private fun addViews(view: IView, depth: Int) {
    ...
    if (view is com.ACSlit.pro.inflater.IViewGroup) {
  ...
  private fun computeChildCount(view: com.ACSlit.pro.inflater.IViewGroup): Int {
    var count = view.childCount
    view.forEachIndexed { index, child ->
      if (index != view.childCount - 1 && child is com.ACSlit.pro.inflater.IViewGroup) {
