...
package com.ACSlit.pro.uidesigner.undo
...
class ViewMovedAction(
    private val child: com.ACSlit.pro.inflater.IView,
    private val fromParent: com.ACSlit.pro.inflater.IViewGroup,
    private val toParent: com.ACSlit.pro.inflater.IViewGroup,
