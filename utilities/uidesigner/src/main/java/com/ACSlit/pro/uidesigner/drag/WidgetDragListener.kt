...
package com.ACSlit.pro.uidesigner.drag
...
import com.ACSlit.pro.uidesigner.fragments.DesignerWorkspaceFragment.Companion.DRAGGING_WIDGET_MIME
        ...
        val name =
            when (val data = event.localState) {
              ...
              is UiWidget -> data.name
                  ...
                  throw IllegalArgumentException("A local state of UiWidget or IView is expected")
            }
