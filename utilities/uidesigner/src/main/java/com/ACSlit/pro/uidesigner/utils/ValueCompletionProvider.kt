...
import com.ACSlit.pro.lsp.util.setupLookupForCompletion
...
internal class ValueCompletionProvider(
    ...
    private val attribute: com.ACSlit.pro.inflater.IAttribute,
  ...
  override fun afterTextChanged(s: Editable?) {
    ...
    if (attribute.name.equals("background", ignoreCase = true)) {
      val backgroundSuggestions = BackgroundCompletions.getBackgroundSuggestions(value)
      ThreadUtils.runOnUiThread { onComplete(backgroundSuggestions) }
      return
    }
  ...
  class CompletionThread(
    ...
    var prefix: String = ""
    var attribute: com.ACSlit.pro.inflater.IAttribute? = null
