...
package com.ACSlit.pro.uidesigner
...
import com.ACSlit.pro.actions.ActionItem.Location.UI_DESIGNER_TOOLBAR
...
import com.ACSlit.pro.uidesigner.actions.clearUiDesignerActions
import com.ACSlit.pro.uidesigner.actions.registerUiDesignerActions
import com.ACSlit.pro.uidesigner.databinding.ActivityUiDesignerBinding
import com.ACSlit.pro.uidesigner.fragments.DesignerWorkspaceFragment
import com.ACSlit.pro.uidesigner.utils.ViewToXml
...
class UIDesignerActivity : BaseIDEActivity() {
  ...
  private val backPressHandler =
      object : OnBackPressedCallback(true) {
        override fun handleOnBackPressed() {
          ...
          ViewToXml.generateXml(frag.requireContext(), frag.workspaceView, ::onXmlGenerated) {
              result,
              error ->
  ...
  fun setupHierarchy(view: com.ACSlit.pro.inflater.IView) {
