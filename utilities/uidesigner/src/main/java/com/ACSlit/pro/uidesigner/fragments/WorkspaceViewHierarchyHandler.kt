...
import com.ACSlit.pro.inflater.viewGroup
import com.ACSlit.pro.uidesigner.R
import com.ACSlit.pro.uidesigner.models.PlaceholderView
import com.ACSlit.pro.uidesigner.undo.ViewAddedAction
import com.ACSlit.pro.uidesigner.undo.ViewMovedAction
import com.ACSlit.pro.uidesigner.undo.ViewRemovedAction
...
internal class WorkspaceViewHierarchyHandler : IViewGroup.SingleOnHierarchyChangeListener() {
  ...
  private fun animateLayoutChange() {
    ...
    TransitionManager.beginDelayedTransition(
        ...
        ChangeBounds().setDuration(DesignerWorkspaceFragment.HIERARCHY_CHANGE_TRANSITION_DURATION),
    )
  }
  ...
  override fun beforeViewAdded(group: IViewGroup, view: com.ACSlit.pro.inflater.IView, index: Int) {
    animateLayoutChange()
  }
  ...
  override fun onViewAdded(group: IViewGroup, view: com.ACSlit.pro.inflater.IView, index: Int) {
    val frag = this.fragment ?: return
    ...
    // FIXED: Save M3 components to workspace state when they are added
    if (view !is PlaceholderView) {
      frag.saveM3ComponentToState(view)
    }

    pushAction(view, group, index, true)
  }

  override fun onViewRemoved(group: IViewGroup, view: com.ACSlit.pro.inflater.IView, index: Int) {
    val frag = this.fragment ?: return
