package com.ACSlit.pro.flashbar
...
import com.ACSlit.pro.flashbar.Flashbar.Companion.DURATION_INDEFINITE
import com.ACSlit.pro.flashbar.Flashbar.DismissEvent
import com.ACSlit.pro.flashbar.Flashbar.DismissEvent.*
import com.ACSlit.pro.flashbar.Flashbar.Gravity.BOTTOM
import com.ACSlit.pro.flashbar.Flashbar.Gravity.TOP
import com.ACSlit.pro.flashbar.Flashbar.OnBarDismissListener
import com.ACSlit.pro.flashbar.Flashbar.OnBarShowListener
import com.ACSlit.pro.flashbar.Flashbar.OnTapListener
import com.ACSlit.pro.flashbar.Flashbar.Vibration
import com.ACSlit.pro.flashbar.Flashbar.Vibration.DISMISS
import com.ACSlit.pro.flashbar.Flashbar.Vibration.SHOW
import com.ACSlit.pro.flashbar.SwipeDismissTouchListener.DismissCallbacks
import com.ACSlit.pro.flashbar.anim.FlashAnim
import com.ACSlit.pro.flashbar.anim.FlashAnimBarBuilder
import com.ACSlit.pro.flashbar.anim.FlashAnimIconBuilder
import com.ACSlit.pro.flashbar.util.NavigationBarPosition.*
import com.ACSlit.pro.flashbar.util.afterMeasured
import com.ACSlit.pro.flashbar.util.getNavigationBarPosition
import com.ACSlit.pro.flashbar.util.getNavigationBarSizeInPx
import com.ACSlit.pro.flashbar.util.getRootView

/**
 * Container withView matching the height and width of the parent to hold a FlashbarView. It will
 * occupy the entire screens size but will be completely transparent. The FlashbarView inside is the
 * only visible component in it.
 */
internal class FlashbarContainerView(context: Context) : RelativeLayout(context), DismissCallbacks {
  ...
  private var gravity: Flashbar.Gravity = BOTTOM
  ...
  internal fun setGravity(gravity: Flashbar.Gravity) {
  ...
  internal fun adjustOrientation(activity: Activity) {
    ...
    when (navigationBarPosition) {
      ...
      com.ACSlit.pro.flashbar.util.NavigationBarPosition.TOP ->
          flashbarContainerViewLp.topMargin = navigationBarSize
      RIGHT -> flashbarContainerViewLp.rightMargin = navigationBarSize
      com.ACSlit.pro.flashbar.util.NavigationBarPosition.BOTTOM ->
          flashbarContainerViewLp.bottomMargin = navigationBarSize
    }
