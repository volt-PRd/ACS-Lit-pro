...
import com.ACSlit.pro.flashbar.Flashbar.Gravity
import com.ACSlit.pro.flashbar.Flashbar.Gravity.BOTTOM
import com.ACSlit.pro.flashbar.Flashbar.Gravity.TOP
import com.ACSlit.pro.flashbar.Flashbar.OnActionTapListener
import com.ACSlit.pro.flashbar.Flashbar.OnTapListener
import com.ACSlit.pro.flashbar.Flashbar.ProgressPosition
import com.ACSlit.pro.flashbar.Flashbar.ProgressPosition.LEFT
import com.ACSlit.pro.flashbar.Flashbar.ProgressPosition.RIGHT
...
import com.ACSlit.pro.flashbar.databinding.FlashBarViewBinding
import com.ACSlit.pro.flashbar.util.getStatusBarHeightInPx
...
class FlashbarView(context: Context) : LinearLayout(context) {
  ...
  fun setIconColorFilter(colorFilter: Int?, filterMode: PorterDuff.Mode?) {
    if (colorFilter == null) {
      this.fbIcon.clearColorFilter() // Clear any existing color filter
      return
    }
    if (filterMode == null) {
