...
import com.ACSlit.pro.utils.intByteMapOf
...
internal val LIKELY_SCRIPTS =
    intByteMapOf(
        ...
        0x83390000.toInt() to 40,
    ) // zza -> Latn

internal val REPRESENTATIVE_LOCALES =
    setOf(
...
internal val ARAB_PARENTS =
    mapOf(
        ...
        0x6172544E to 0x61729420,
    ) // ar-TN -> ar-015

internal val HANT_PARENTS = mapOf(0x7A684D4F to 0x7A68484B) // zh-Hant-MO -> zh-Hant-HK

internal val LATN_PARENTS =
    mapOf(
        ...
        0x7074544c to 0x70745054,
    ) // pt-TL -> pt-PT

internal val SCRIPT_PARENTS =
    mapOf("Arab" to ARAB_PARENTS, "Hant" to HANT_PARENTS, "Latn" to LATN_PARENTS)
