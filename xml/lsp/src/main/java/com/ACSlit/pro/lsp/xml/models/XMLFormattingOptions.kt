...
package com.ACSlit.pro.lsp.xml.models

import com.ACSlit.pro.lsp.xml.providers.format.FormatElementCategory
import com.ACSlit.pro.lsp.xml.providers.format.FormatElementCategory.PreserveSpace
...
open class XMLFormattingOptions : BaseXmlFormattingOptions() {
  ...
  override val emptyElementsBehavior: EmptyElements
    get() = EmptyElements.valueOf(XmlPreferences.emptyElementsBehavior)
