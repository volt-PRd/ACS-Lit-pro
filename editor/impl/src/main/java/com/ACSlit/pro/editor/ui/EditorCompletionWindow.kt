...
import com.ACSlit.pro.lsp.util.DocumentationReferenceProvider
import com.ACSlit.pro.progress.ProgressManager
import com.ACSlit.pro.utils.KeyboardUtils
  ...
  override fun setLayout(layout: CompletionLayout) {
    ...
    (layout.completionList as? ListView)?.let {
      ...
      it.setOnItemLongClickListener { _, view, position, _ ->
        val data =
            (items[position] as? com.ACSlit.pro.lsp.models.CompletionItem)?.data
