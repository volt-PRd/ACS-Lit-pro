...
import com.ACSlit.pro.actions.EditorActionItem
import com.ACSlit.pro.actions.FillMenuParams
import com.ACSlit.pro.editor.R.layout
import com.ACSlit.pro.editor.databinding.LayoutPopupMenuItemBinding
import com.ACSlit.pro.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(com.ACSlit.pro.models.Range::class.java, editor.cursorLSPRange)
    data.put(
