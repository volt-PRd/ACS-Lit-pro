...
package com.ACSlit.pro.terminal
...
import com.ACSlit.pro.app.configuration.CpuArch
  ...
  companion object {
    ...
    private fun writeIdesetupScript(context: Context, script: File): Boolean {
      return try {
        ...
        val folderName =
            when (cpuArch) {
              com.ACSlit.pro.app.configuration.CpuArch.AARCH64 -> "arm64"
              com.ACSlit.pro.app.configuration.CpuArch.ARM -> "arm"
              com.ACSlit.pro.app.configuration.CpuArch.X86_64 -> "x86_64"
              com.ACSlit.pro.app.configuration.CpuArch.X86 -> "x86"
            }
